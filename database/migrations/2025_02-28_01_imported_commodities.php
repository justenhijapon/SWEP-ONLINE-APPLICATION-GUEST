    ...
    public function up()
    {
        ...
        if (!Schema::hasTable('imported_commodities')) {
            ...
            Schema::table('imported_commodities', function (Blueprint $table) {
                ...
                if (!Schema::hasColumn('imported_commodities', 'submission')) {
                    $table->integer('submission')->default(0);
                }
                if (!Schema::hasColumn('imported_commodities', 'submission_date')) {
                    $table->string('submission_date')->nullable();
                }
                if (!Schema::hasColumn('imported_commodities', 'received')) {
                    $table->integer('received')->default(0);
                }
                if (!Schema::hasColumn('imported_commodities', 'received_date')) {
                    $table->string('received_date')->nullable();
                }
                if (!Schema::hasColumn('imported_commodities', 'revoked')) {
                    $table->integer('revoked')->default(0);
                }
                if (!Schema::hasColumn('imported_commodities', 'revoked_date')) {
                    $table->string('revoked_date')->nullable();
                }
