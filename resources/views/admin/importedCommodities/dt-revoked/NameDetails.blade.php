...
<small>Company Address: </small><span style="text-indent: 40px; text-align: justify;">{{ \Illuminate\Support\Str::title($data->address) }}</span>
...
<div id="accordion">
    ...
    <div id="more_details" class="collapse">
        ...
        <small>Contact No.: </small><span>{{ $data->contact_no }}</span>
    </div>
</div>