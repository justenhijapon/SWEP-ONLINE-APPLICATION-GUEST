...
@section('scripts')
    ...
    {{--    my_payments_tbl.ajax.url('{{ route("dashboard.ImportedCommodities.index") }}?status='+status+'&transaction_type='+transaction_type).load();--}}
    ...
    {{--    tr_id = $(this).attr('data');--}}
    {{--    window.open("{{route('dashboard.landBank', 'id')}}".replace('id', tr_id), '_blank').focus();--}}
