...
{{--                headers: {--}}
{{--                    'X-HTTP-Method-Override': 'PATCH', // Override the POST method with PATCH--}}
{{--                    {!! __html::token_header() !!}--}}
{{--                },--}}
...
{{--        --}}{{--var existingImgUrlITB = "/show_file_custom/invitation_bid/{{$invitationBid->slug}}/path_itb"; // Replace with actual URL or path to the existing file--}}
{{--        --}}{{--var existingImgUrlPBD = "/show_file_custom/invitation_bid/{{$invitationBid->slug}}/path_pbd"; // Replace with actual URL or path to the existing file--}}

{{--        --}}{{--// Function to initialize fileinput with or without preview based on the file existence--}}
...
{{--        --}}{{--initializeFileInput("img_url_itb", existingImgUrlITB);--}}
